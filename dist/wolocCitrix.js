...
async function updateApplicationTimelineFromWoloc(statusLogs) {
    for (let value of statusLogs) {
        let woloc_status = value.status;
        let statusDateTime = value.statusDateTime;
        const wolocIndependentStatus = [
            'DISBCOMP',
            '12o2',
            '8o10',
            'EXLAW',
